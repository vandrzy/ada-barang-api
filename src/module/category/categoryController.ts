...
import { CreateCategoryRequest, GetAllCategoriesRequest, GetAllCategoriesResponse } from './categoryDto';
...
export const getAllCategories = asyncHandler(async (req: Request, res: Response) => {
    ...
    const categories = await categoryService.gelAllCategories(sortBy, order, limit, offset);
    res.status(200).json(successResponse('Berhasil menampilkan data kategori', categories));
})