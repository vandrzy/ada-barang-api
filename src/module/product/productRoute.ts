...
route.get('/:hortCode', loginMiddleware.authMiddleware, loginMiddleware.authorizeMiddleware(['admin', 'user']), requestMiddleware.validateParams(productRequest.shortCodeProductParams), productController.getProductByShortCode);
